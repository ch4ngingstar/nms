// discover recon runner (spec §6.4 `discovery` mapping; protocol result key
// "hosts"). ICMP echo sweep across the requested targets (single IPs or a CIDR
...
// schema-invalid {"up":[...]}; the result schema's key is "hosts" (§9.2 golden).
#pragma once
