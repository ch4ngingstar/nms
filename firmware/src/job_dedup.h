// Duplicate job_id suppression ring — pure and host-testable,
...
// logic lives here — the ring's *owner* stays the MQTT task in mqtt_client
// (single-writer), which holds one instance and never shares it across tasks.
#pragma once

#include <stddef.h>
#include <stdint.h>

// Depth of the ring: the last 8 accepted job_ids are remembered.
